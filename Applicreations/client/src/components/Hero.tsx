...
export function Hero() {
  ...
  return (
    <section 
      id="home" 
      ref={heroRef}
      className="hero min-h-screen flex flex-col px-0 m-0 overflow-hidden"
      style={{ 
        background: 'none', /* Remove individual background */
        paddingTop: 'env(safe-area-inset-top, 0)', /* Start from absolute top */
        paddingBottom: '180px',
        margin: 0,
        border: 'none',
        boxShadow: 'none',
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-10">
        ...
        <div 
          className={`text-center transform transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} mb-[40px] mt-[50px]`}
