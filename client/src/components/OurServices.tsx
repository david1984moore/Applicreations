...
export function OurServices() {
  ...
  return (
    <section id="our-services" ref={sectionRef} className="pt-40 pb-16 bg-white light-bg-section" style={{ marginTop: "-40px", position: "relative", zIndex: 0 }}>
            ...
            <div className="md:col-span-4 flex justify-center items-center py-4">
              <div className="relative">
                ...
                <div className="relative z-10">
                  <svg className="h-28 w-28 text-purple drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
