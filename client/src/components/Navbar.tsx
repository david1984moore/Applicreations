          ...
          >
            {mobileMenuOpen ? (
              <div className="w-7 h-7 flex flex-col justify-center items-center">
                <div className="w-6 h-0.5 bg-white mb-1.5 transform rotate-45 translate-y-1"></div>
                <div className="w-6 h-0.5 bg-white opacity-0"></div>
                <div className="w-6 h-0.5 bg-white mt-1.5 transform -rotate-45 -translate-y-1"></div>
              </div>
            ) : (
              <div className="w-7 h-7 flex flex-col justify-center items-center">
