    ...
    <section id="pricing" className="py-20 md:py-28 bg-blue-50">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
            ...
            <div className="px-6 pb-6">
              <a
                href="#contact"
                className="block w-full bg-primary hover:bg-primary/90 text-white py-3 px-6 rounded-full font-medium text-center"
              >
                Get Started
              </a>
            </div>
        ...
        <div className="mt-16 text-center">
          <a
            href="#contact"
            className="inline-block bg-primary hover:bg-primary/90 text-white py-3 px-8 rounded-full font-medium text-center"
          >
